...
pub const PROTOCOL_CLAIM_EVENT_DISCRIMINATOR: [u8; 8] =
	[149, 70, 119, 5, 21, 57, 123, 244];

impl ProtocolClaimEvent {
	...
	pub fn matches(program_id: &solana_address::Address, data: &[u8]) -> bool {
		program_id == &crate::launchpad::generated::SEND_LAUNCHPAD_ID
			...
			&& data.get(8..16) == Some(&PROTOCOL_CLAIM_EVENT_DISCRIMINATOR[..])
	}
