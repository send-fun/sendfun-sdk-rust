...
pub fn fetch_bonding_curve(
	...
	crate::launchpad::generated::shared::DecodedAccount<BondingCurve>,
	std::io::Error,
> {
...
pub fn fetch_all_bonding_curve(
	...
	Vec<crate::launchpad::generated::shared::DecodedAccount<BondingCurve>>,
	std::io::Error,
> {
	let accounts = rpc
...
pub fn fetch_maybe_bonding_curve(
	...
	crate::launchpad::generated::shared::MaybeAccount<BondingCurve>,
	std::io::Error,
> {
...
pub fn fetch_all_maybe_bonding_curve(
	...
	Vec<crate::launchpad::generated::shared::MaybeAccount<BondingCurve>>,
	std::io::Error,
> {
	let accounts = rpc
		.get_multiple_accounts(addresses)
