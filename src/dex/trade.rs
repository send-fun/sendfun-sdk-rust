...
pub fn buy_exact_in(
	...
	let q = amm::buy_exact_in_with_fees(amm::BuyArgs {
		...
		base_fee: p.base_fee,
		// No cap: a DEX pool never runs its base side to zero.
...
pub fn build_buy_exact_in_instruction(
	...
	dex_trade_accounts!(super::instructions::BuyExactIn, p).instruction(
...
pub fn build_buy_exact_out_instruction(
	...
	dex_trade_accounts!(super::instructions::BuyExactOut, p).instruction(
...
pub fn build_sell_exact_in_instruction(
	...
	dex_trade_accounts!(super::instructions::SellExactIn, p).instruction(
...
pub fn build_sell_exact_out_instruction(
	...
	dex_trade_accounts!(super::instructions::SellExactOut, p).instruction(
...
fn derive(
	...
	let (pool, _) =
		crate::dex::pda::find_pool_pda(state.base_mint, state.quote_mint);
...
mod tests {
	...
	use super::{
		...
		BuildSellExactOutParams, SellExactInParams,
